...
export default function Home({ searchParams }: HomeProps) {
  ...
  const series = getSeries({ siteFilter, ...last30, period: "day" });
  const prevSeries = getSeries({
    siteFilter,
    ...previousPeriodYoY(last30),
    period: "day",
  }).map((s) => ({
    ...s,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        <div className="card p-5 lg:col-span-2">
          <div className="mb-3 flex items-center justify-between">
            <h3 className="text-sm font-semibold">최근 30일 매출 추이</h3>
      ...
      <div className="card p-5">
        <h3 className="mb-3 text-sm font-semibold">TOP 5 인기 상품 (이번 달)</h3>
